...
Once you've added your information to the template, delete this file and reproduct\_\_name
the `README-template.md` file to `README.md`. That will make it show up as your repository's README file.
